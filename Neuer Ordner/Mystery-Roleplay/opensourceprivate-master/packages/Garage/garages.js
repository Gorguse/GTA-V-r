...
let garage31 = mp.colshapes.newSphere(-673,899,229, 3, 0);
let garage32 = mp.colshapes.newSphere(-170,918,235, 3, 0);
let garage33 = mp.colshapes.newSphere(-121,1011,235, 3, 0);
let garage34 = mp.colshapes.newSphere(-463,636,144, 3, 0);
let garage35 = mp.colshapes.newSphere(-527,520,112, 3, 0);
let garage36 = mp.colshapes.newSphere(-537,480,103, 3, 0);
let garage37 = mp.colshapes.newSphere(1390,-611,74, 3, 0);
let garage38 = mp.colshapes.newSphere(1318,-517,71, 3, 0);
...
mp.events.add("PushE", (player) => {
  if (mp.players.exists(player)) {
    if(garage5.isPointWithin(player.position) && player.data.mainmenu == false) {
        ...
        player.data.mainmenu = true;
    } else if(garage35.isPointWithin(player.position) && player.data.mainmenu == false) {
        ...
        player.data.mainmenu = true;
    } else if(garage37.isPointWithin(player.position) && player.data.mainmenu == false) {
        player.call("client:garage:openmenu",[37]);    
        player.data.mainmenu = true;
    } else if(garage38.isPointWithin(player.position) && player.data.mainmenu == false) {

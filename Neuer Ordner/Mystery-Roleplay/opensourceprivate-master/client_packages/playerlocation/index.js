...
mp.events.add("render", () => {
    if (streetName && zoneName) {
        ...
        if (useSpeedo && vehicle) {
            ...
            //Speed
            drawText(`~b~${(vehicle.getSpeed() * (isMetric ? 3.6 : 2.236936)).toFixed(0)}`, [minimap.rightX + 0.01, minimap.bottomY - 0.095], 4, [255, 255, 255, 255], 0.6);
        ...
        //Servername + Version
        drawText('Mystery - Roleplay Alpha', [minimap.rightX + 0.01, minimap.bottomY - 0.03], 4, [255, 255, 255, 255], 0.4);
    }
});

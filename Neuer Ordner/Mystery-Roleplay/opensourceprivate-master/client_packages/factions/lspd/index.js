...
mp.events.add("client:lspd:openMainMenu", (factionrang) => {
  ...
  mainMenuLSPD.AddItem(new UIMenuItem("Fahrzeug Beschlagnahmen","Fahrzeug beschlagnahmen"));
    if(factionrang > 10){
...
clothesLSPD.AddItem(new UIMenuItem("Sondereinsatz-Uniform","Die Sondereinsatz Uniform"));
...
mp.events.add("client:lspd:Weapons", (ausnahme) => {
...
mp.events.add("client:lspd:weaponssee", (taser,pistol,fivepistol,schwerepistol,appistol,smg,pdw,karabiner,pump,taschenlampe,schlagstock,messer,bat,target) => {
